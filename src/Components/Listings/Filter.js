...
export default class Filter extends React.Component {
  ...
  render() {
    return (
      <Row className="filterContainer py-3" xs="2" md="4" lg="6">
        <Col className="p-1">
          <InputGroup>
            <Input
        ...
        <Col className="p-1">
          <InputGroup>
            <Input
              className="filterItem"
              onChange={this.minRozloha}
              placeholder="Min. rozloha v m2"
            />
          </InputGroup>
        </Col>
        <Col className="p-1">
          <InputGroup>
            <Input
              className="filterItem"
              onChange={this.minPozemok}
              placeholder="Min. pozemok v m2"
            />
          </InputGroup>
        </Col>
        <Col className="p-1">
